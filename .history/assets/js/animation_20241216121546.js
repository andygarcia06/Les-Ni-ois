document.addEventListener("DOMContentLoaded", function () {
    ...
    // Vérification de l'appareil tactile ou tablette/desktop
    ...
    sections.forEach((section, index) => {
        ...
        if (isTouchDevice) {
            ...
            // Gérer le comportement pour les appareils desktop ou tablettes
            section.addEventListener("click", (event) => {
                event.preventDefault();
                ...
                if (previousSection && previousSection !== section) {
                    ...
                    // Masquer le hover de la section précédente
                    gsap.to(prevBackground, {
                        left: "-100%",
                        duration: 0.3,
                        ease: "power2.in",

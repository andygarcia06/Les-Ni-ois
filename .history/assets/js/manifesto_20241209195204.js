document.addEventListener("DOMContentLoaded", () => {
    ...
    // Images nécessitant un style spécifique
    const centeredImages = [
        "./assets/img/restaurant/center/7.jpg", // Ricard
        "./assets/img/restaurant/right/7.jpg",  // Papi
        "./assets/img/restaurant/left/1.jpg",   // Croquette
        "./assets/img/restaurant/right/8.jpg",  // Tiramisu
        "./assets/img/restaurant/right/5.jpg",  // Bouteilles
        "./assets/img/restaurant/right/9.jpg",  // Resto
        "./assets/img/restaurant/right/1.jpg",  // Anchois
        "./assets/img/restaurant/left/2.jpg",   // Pissaladière
        "./assets/img/restaurant/center/4.jpg", // Croquette
        "./assets/img/restaurant/center/3.jpg", // Bagnat
        "./assets/img/restaurant/left/9.jpg",   // Bagnat
        "./assets/img/restaurant/center/1.jpg", // Parasol
    ];
    ...
    function crossfadeImages(currentId, nextId, images, index) {
        ...
        if (currentImage && nextImage) {
            ...
            // Appliquer un style spécifique si l'image fait partie des images centrées
            if (centeredImages.includes(imageUrl)) {
                currentImage.style.backgroundPosition = "center";
                currentImage.style.backgroundSize = "contain"; // Ajuster pour le centrage
            } else {
                currentImage.style.backgroundPosition = "initial";
                currentImage.style.backgroundSize = "cover"; // Par défaut
            }
    ...
    const middleTimer = 2000; // Décalage de 2 secondes
    const rightTimer = 2000;  // Décalage de 4 secondes

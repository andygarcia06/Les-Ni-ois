document.addEventListener("DOMContentLoaded", function () {
    ...
    sections.forEach((section) => {
        ...
        section.addEventListener("mouseleave", (event) => {
            ...
            // Réduire l'opacité uniquement si on ne sort pas de la fenêtre
            if (!isMouseOutOfWindow(event)) {
                gsap.to(content, {
                    opacity: 0,
                    duration: 0.5,
                    ease: "power2.in",
            ...
            // Réinitialiser l'activeSection si la souris quitte complètement la section
            activeSection = null;
        });
    });

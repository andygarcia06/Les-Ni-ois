        ...
        if (isTouchDevice) {
            ...
            section.addEventListener("click", (event) => {
                ...
                if (previousSection && previousSection !== section) {
                    ...
                    const isGoingDown = previousSection 
                    ? index > Array.from(sections).indexOf(previousSection)
                    : true; // Direction par défaut
        ...
        section.addEventListener("mouseenter", (event) => {
            ...
            if (!firstInteractionDone) {
                ...
                if (isEnteringFromLeft) {
                    // Première interaction : configurez pour venir de la droite
                    background.style.left = "100%";
                } else if (isEnteringFromRight) {
                    // Première interaction : configurez pour venir de la gauche
                    background.style.left = "-100%";
                }
            }
            ...
            // Marquer la première interaction comme terminée

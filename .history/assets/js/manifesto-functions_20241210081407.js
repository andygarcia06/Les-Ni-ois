...
document.addEventListener("DOMContentLoaded", () => {
    ...
    restoLink.addEventListener("click", (e) => {
        ...
        // Basculer la classe "active" pour afficher/masquer le sous-menu
        if (submenuResto.classList.contains("active")) {
            submenuResto.classList.remove("active");
        } else {
            submenuResto.classList.add("active");
        }
    });

    // Optionnel : Fermer le sous-menu en cliquant ailleurs sur la page
    document.addEventListener("click", (e) => {
        if (!restoLink.contains(e.target) && !submenuResto.contains(e.target)) {
            submenuResto.classList.remove("active");
        }
    });
});

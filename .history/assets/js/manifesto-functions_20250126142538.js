...
const submenu = document.querySelector("#submenu-resto-nav");

// Affichage du container (burger button)
burger.addEventListener("click", () => {
    menuContainer.classList.toggle("open"); // Affiche ou cache le container
});

// Fermeture du side-menu
closeButton.addEventListener("click", () => {
    menuContainer.classList.remove("open"); // Cache le container
});

// Gestion de l'affichage du submenu (clique sur RESTO dans le side-menu)
sideMenu.querySelector(".big-menu-item a").addEventListener("click", (e) => {
    e.preventDefault();
    submenu.classList.toggle("active"); // Affiche ou cache le submenu

...
// Variable pour bloquer les actions répétées
...
// Fonction pour basculer entre lecture et pause avec gestion du debouncing
function toggleRadioState() {
    if (isToggling) return; // Si une action est déjà en cours, on ignore le clic
    isToggling = true;
    ...
    // Débloque après 500 ms (ajustez la durée si besoin)
    setTimeout(() => {
        isToggling = false;
    }, 500);
}

...
// Change newletter image

function updateImageSource() {
    const img = document.getElementById('newsletterImage');
    if (window.innerWidth <= 768) {
        img.src = './assets/img/contact/newsletter.jpg';
    } else {
        img.src = './assets/img/contact/newsletter-2.jpg';
    }
}
...
// Écoute les changements de taille d'écran pour mettre à jour l'image dynamiquement

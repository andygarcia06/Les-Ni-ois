document.addEventListener("DOMContentLoaded", function () {
    ...
    sections.forEach((section) => {
        ...
        section.addEventListener("mouseenter", (event) => {
            ...
            if (!firstInteractionDone) {
                ...
                if (isEnteringFromLeft) {
                    // Positionner le hover-background pour entrer depuis la droite
                    background.style.left = "100%";
                } else if (isEnteringFromRight) {
                    // Positionner le hover-background pour entrer depuis la gauche
                    background.style.left = "-100%";
                }
            }
        ...
        section.addEventListener("mouseleave", (event) => {
            ...
            // Réduire l'opacité du contenu à 0
            gsap.to(content, {
                opacity: 0,
                duration: 0.5,
                ease: "power2.in",

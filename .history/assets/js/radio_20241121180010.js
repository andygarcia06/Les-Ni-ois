...
// Références aux éléments dans le DOM
const audioElement = document.getElementById("radio-player"); // L'élément audio sur la page

// Fonction pour synchroniser l'état de lecture/pause
...
// Fonction pour restaurer l'état au chargement de la page
function restoreState() {
    syncPlaybackState(); // Synchronise lecture/pause
    syncVolume(); // Synchronise le volume
}

// Écouteur pour les modifications dans localStorage

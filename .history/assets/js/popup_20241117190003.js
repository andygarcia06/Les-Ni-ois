...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const privatisationContent = document.getElementById('privatisation-content');
    const header = document.querySelector('.popup-reservation-header');
    const popupFrame = document.querySelector('.popup-reservation-frame');
    const closeButton = document.querySelector('.popup-reservation-close');

    // Side Menu Buttons
    const reserverButton = document.querySelector('.submenu li a[href="#"]'); // Assuming "Réserver" is the first link in the submenu
    const privatiserButton = document.querySelector('.submenu li:nth-child(3) a'); // Assuming "Privatiser" is the third link in the submenu
    ...
    // Function to show reservation content
    ...
    // Function to show privatisation content
    ...
    // Ensure the correct content is shown on popup tab click
    reservationTab.addEventListener('click', showReservationContent);
    privatisationTab.addEventListener('click', showPrivatisationContent);
});

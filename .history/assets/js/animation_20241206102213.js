...
const navMenu = document.querySelector(".restaurant-nav"); // Sélectionnez le menu principal
const closeButton = document.querySelector(".close-popup-side-menu");

// Fonction pour cacher le menu avec animation
function hideNavMenu() {
    navMenu.classList.remove("nav-visible"); // Supprime l'état visible
    navMenu.classList.add("nav-hidden"); // Applique l'animation de disparition
}

// Fonction pour afficher le menu avec animation
function showNavMenu() {
    navMenu.classList.remove("nav-hidden"); // Supprime l'état caché
    navMenu.classList.add("nav-visible"); // Applique l'animation de réapparition
}

// Gère l'ouverture du side menu
burger.addEventListener("click", function () {
    sideMenu.classList.toggle("open"); // Bascule l'état d'ouverture du side menu

    if (sideMenu.classList.contains("open")) {
        hideNavMenu(); // Cache le menu principal
    } else {
        showNavMenu(); // Affiche le menu principal
    }
});

// Gère la fermeture du side menu
if (closeButton) {

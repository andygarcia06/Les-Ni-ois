...
app.get('/restaurant', (req, res) => {
    res.sendFile(join(__dirname, 'restaurant.html'));
});
...
// Route pour /newsletter
app.get('/newsletter', (req, res) => {
    res.sendFile(join(__dirname, 'newsletter.html'));
});

// Route pour /radio
app.get('/radio', (req, res) => {
    res.sendFile(join(__dirname, 'radio.html'));
});

// Route pour /cgv
app.get('/cgv', (req, res) => {
    res.sendFile(join(__dirname, 'cgv.html'));
});
